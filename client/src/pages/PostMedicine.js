            ...
            <div className='mx-auto bg-gradient-to-r from-primary-dark to-primary-light min-h-screen rounded-xl text-white w-3/4'>
                ...
                <div className='flex justify-center space-x-4 '>
                    ...
                    <img src={girl} alt="image" className='-translate-y-4'/>
                        <div className="flex flex-col h-[100vh] mb-7 items-center justify-center">
                            <div className='py-2 px-4'>
                                <label className="font-medium text-lg">Common Name:</label>
                                <div className="flex flex-row flex-wrap justify-between">
                                    <input type='text' name='commonName' className="rounded-xl border border-purple w-96 p-1 text-primary-black" />
                                </div>
                            </div>
                            ...
                            <div className='py-2 px-4'>
                                ...
                                <div className="flex flex-row flex-wrap justify-between">
                                    <input type='number' name='quantity' className="rounded-xl border border-purple w-96 p-1 text-primary-black"/>
                                </div>
                            </div>
                            ...
                            <div className='py-2 px-4'>
                                ...
                                <div className="flex flex-row flex-wrap justify-between">
                                    <input type='date' name='expiry_date' className="rounded-xl border border-purple w-96 p-1 text-primary-black" />
                                </div>
                            </div>
                            ...
                            <div className='py-2 px-4'>
                                ...
                                <div className="flex flex-row flex-wrap justify-between">
                                    <input type='text' name='scientificName' className="rounded-xl border border-purple w-96 p-1 text-primary-black" />
                                </div>
                            </div>
                            ...
                            <div className='py-2 px-4'>
                                ...
                                <div className="flex flex-row flex-wrap justify-between">
                                    <input type='file' name='picture' className="rounded-xl border border-purple w-96 p-1 text-primary-black" />
                                </div>
                            </div>
                            ...
                            <div className='py-2 px-4'>
                                ...
                                <div className="flex flex-row flex-wrap justify-between">
                                    <input type='string' name='picture' className="rounded-xl border border-purple w-96 p-1 text-primary-black" />
                                </div>
                            </div>
